...
class _EmployeeDirectoryScreenState extends State<EmployeeDirectoryScreen> {
  ...
  void getemplist() async {
    ...
    // Future<dynamic> temp =
    employeelist(prefs.getString('branch_id').toString(), prefs.getString('company_id').toString());
    /*temp.then((value) {
      setState(() {
        ...
        children: [
          ...
          Column(
            children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        onChanged: (text) {
                          ...
                          if(text.toString().trim().isEmpty || text.toString().toString().length == 0){
                        ...
                        onTap: () {
                            showDialog(context: context, barrierDismissible: false, builder: (context)=> StatefulBuilder(
                                builder: (context, setState){
                                  return AlertDialog(title: Text("Select"),content:
                                  Container(
                                    ...
                                    child: Column(
                                        children:[
                                              ...
                                              onChanged: (String data) {
                                                setState(() {
                                                  companylistData.forEach((element) {
                                                    if(element['company_name'].toString() == data.toString()){
                                                      initialcompanyname = data.toString();
                                                      company_id = element['id'].toString();
                                                    }
                                                  });
                                                });
                                              },
                                              items: _companydata.map<DropdownMenuItem<String>>((String value) {
                                              ...
                                              onChanged: (String data) {
                                                setState(() {
                                                  branchlistData.forEach((element) {
                                                    if(element['branch_name'].toString() == data.toString()){
                                                      initialbranchname = data.toString();
                                                      branch_id = element['id'].toString();
                                                    }
                                                  });
                                                });
                                              },
                                              items: _branchdata.map<DropdownMenuItem<String>>((String value) {
                                                return DropdownMenuItem<String>(
                                                  value: value,
                                                  child: Text(value),
                                                );
                                          ...
                                          InkWell(
                                            onTap: () {
                                              if(initialcompanyname == null || initialcompanyname == ""){
                                              ...
                                              else if(initialbranchname == null || initialbranchname == ""){
                                                Navigator.pop(context);
                                                setState(() {
                                                   branch_id = "";
                                                  _searchResult.clear();
              ...
              listCheck == false ? Expanded(child: Center(
                ...
                child: Padding(
                    ...
                    child: GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio: 0.83),
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                              fit: BoxFit.cover,
                                              image: _searchResult[index].empImage == null || _searchResult[index].empImage == ""
                                                  ? const AssetImage(
                                                  'assets/images/no_image.jpg')
                                                  : NetworkImage(
                                                  _searchResult[index].empImage),
                                            ),
                                          ),
                                        ),
                                      ),
                                          ...
                                          Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) => ProfileViewScreen(
                                                      name: _searchResult[index].empName,
                                                      id: _searchResult[index].empId,
                                                      photo: _searchResult[index].empImage,
                                                      designation: _searchResult[index].desigName,
                                                      department: _searchResult[index].deptName,
                                                      company : _searchResult[index].compName,
                                                      dob: _searchResult[index].empDob,
                                                      mobile: _searchResult[index].empMobile,
                                                      email: _searchResult[index].empMail,
                                                      joiningdate: _searchResult[index].empJoinDateDdmmyy,
  ...
  _companyDialogBox(){
    ...
    //   },
    // );
    return showDialog(context: context, builder: (context)=> AlertDialog(title: Text("Select2"),content: Container(
      child: Row(
        children: [
          FormField(
              ...
              child: Scrollbar(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return companylist(
                        context, index, companylistData[index]['company_name'].toString());
                  },
                ),
              ))
        ],
              ...
              Container(
                  ...
                  child: Scrollbar(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return branchlist(context, index, branchlistData[index].branchName);
                      },
                    ),
                  ))
            ],
