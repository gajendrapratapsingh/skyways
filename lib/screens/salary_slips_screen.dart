...
class _SalarySlipScreenState extends State<SalarySlipScreen> {
  ...
  _getCurrentYear(){
      ...
      setState(() {
         ...
         years = (int.parse(selectedDate.year.toString())-1).toString()+"-"+selectedDate.year.toString();
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                          ...
                          child: Text("Salary Slips", textAlign: TextAlign.center, style: TextStyle(color: Colors.black87, fontSize: 16.0, fontWeight: FontWeight.bold))),
                    ],
                  ),
                ),
                                      ...
                                      if(list.isEmpty || list == "" || list == null){
                                        ...
                                        return ListView.separated(
                                            separatorBuilder: (context, index) {
                                              return Divider(color: Colors.transparent, height: 8.0);
                                            },
                                            padding: EdgeInsets.zero,
                                            itemCount: list.length,
                                            itemBuilder: (BuildContext context,int index) {
                                              if(list[index].month == "1"){
                                                return _listItem(tilelist[0], monthlist[0], list[index].filePath);
                                              }
                                              if(list[index].month == "2"){
                                                return _listItem(tilelist[1], monthlist[1], list[index].filePath);
                                              }
                                              if(list[index].month == "3"){
                                                return _listItem(tilelist[2], monthlist[2], list[index].filePath);
                                              }
                                              if(list[index].month == "4"){
                                                return _listItem(tilelist[3], monthlist[3], list[index].filePath);
                                              }
                                              if(list[index].month == "5"){
                                                return _listItem(tilelist[4], monthlist[4], list[index].filePath);
                                              }
                                              if(list[index].month == "6"){
                                                return _listItem(tilelist[5], monthlist[5], list[index].filePath);
                                              }
                                              if(list[index].month == "7"){
                                                return _listItem(tilelist[6], monthlist[6], list[index].filePath);
                                              }
                                              if(list[index].month == "8"){
                                                return _listItem(tilelist[7], monthlist[7], list[index].filePath);
                                              }
                                              if(list[index].month == "9"){
                                                return _listItem(tilelist[8], monthlist[8], list[index].filePath);
                                              }
                                              if(list[index].month == "10"){
                                                return _listItem(tilelist[9], monthlist[9], list[index].filePath);
                                              }
                                              if(list[index].month == "11"){
                                                return _listItem(tilelist[10], monthlist[10], list[index].filePath);
                                              }
                                              if(list[index].month == "12"){
                                                return _listItem(tilelist[11], monthlist[11], list[index].filePath);
                                              }
     ...
     return Row(
       children: [
         CircleAvatar(
           ...
           child: Text(tile, style: TextStyle(color: Colors.white, fontSize: 12.0)),
         ),
         SizedBox(width: 5.0),
         Expanded(
             child: Text(name, style: TextStyle(color: Colors.black, fontSize: 14.0, fontWeight: FontWeight.bold))
         ),
         GestureDetector(
           onTap: (){
             Navigator.pushReplacement(context,
                 MaterialPageRoute(builder: (context) => MyPdfViewerScreen(
                     filepath: filepath,
                 )));
           },
           child: Container(
         ...
         GestureDetector(
           ...
           child: Container(
             ...
             child: const Padding(
               padding: EdgeInsets.only(top: 6.0),
               child: Text("Download", textAlign: TextAlign.center, style: TextStyle(color: Colors.white),),
             ),
           ),
         )
       ],
